...
_NUMBER_FIELD_META: dict[str, dict[str, float | int]] = {
    ...
    "rewards.wall_speed": {"step": 0.1, "min": 0, "max": 5},
        ...
        "sections": {
            ...
            "rewards": _section(
                ...
                "Reward weights",
                {
                    ...
                    "heading_off_track": "Reward for pointing along the local FORWARD track heading while off course; also penalises facing the wrong way.",
                    ...
                    "off_track_terminal": "Crash / wall-hit penalty when terminate-on-off-track ends the episode. Make this large so leaving the circuit is worse than staying on it.",
                    "wall_speed": "Extra wall-hit multiplier from speed. 1.0 doubles the crash penalty at the mode speed cap.",
