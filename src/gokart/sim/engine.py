        ...
        tick = SimTickRecord(
            ...
            values={
                ...
                **{k: v for k, v in track_values.items() if k != "elevation_m"},
                ...
                "tyre_temp_fl_c": physics_out.tyre_temp_front_c,
                "tyre_temp_fr_c": physics_out.tyre_temp_front_c,
                "tyre_temp_rl_c": physics_out.tyre_temp_rear_c,
                "tyre_temp_rr_c": physics_out.tyre_temp_rear_c,
