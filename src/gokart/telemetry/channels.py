...
TELEMETRY_CHANNELS: tuple[TelemetryChannel, ...] = (
    ...
    TelemetryChannel("engine_rpm", "rpm"),
    TelemetryChannel("engine_temp_c", "C"),
    ...
    TelemetryChannel("normal_fl_n", "N"),
    TelemetryChannel("normal_fr_n", "N"),
    TelemetryChannel("normal_rl_n", "N"),
    ...
    TelemetryChannel("tyre_wear_fl", "1"),
    TelemetryChannel("tyre_wear_fr", "1"),
    TelemetryChannel("tyre_wear_rl", "1"),
    TelemetryChannel("tyre_wear_rr", "1"),
    TelemetryChannel("grip_front_effective", "1"),
    TelemetryChannel("grip_rear_effective", "1"),
    TelemetryChannel("grip_fl_effective", "1"),
    TelemetryChannel("grip_fr_effective", "1"),
    ...
    TelemetryChannel("powertrain_type", "1", channel_type="string"),
    ...
    TelemetryChannel("rl_step_reward", "1"),
    TelemetryChannel("rl_episode_reward", "1"),
)
